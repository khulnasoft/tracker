...
const (
	DataSourceService_Write_FullMethodName       = "/tracker.v1beta1.DataSourceService/Write"
	DataSourceService_WriteStream_FullMethodName = "/tracker.v1beta1.DataSourceService/WriteStream"
)
