...
type EventCount struct {
	...
	Id    EventId `protobuf:"varint,1,opt,name=id,proto3,enum=tracker.v1beta1.EventId" json:"id,omitempty"`
...
var file_api_v1beta1_diagnostic_proto_goTypes = []any{
	...
	(*EventCount)(nil),             // 3: tracker.v1beta1.EventCount
	(*ChangeLogLevelRequest)(nil),  // 4: tracker.v1beta1.ChangeLogLevelRequest
	(*ChangeLogLevelResponse)(nil), // 5: tracker.v1beta1.ChangeLogLevelResponse
	(*GetStacktraceRequest)(nil),   // 6: tracker.v1beta1.GetStacktraceRequest
	(*GetStacktraceResponse)(nil),  // 7: tracker.v1beta1.GetStacktraceResponse
	(EventId)(0),                   // 8: tracker.v1beta1.EventId
}
var file_api_v1beta1_diagnostic_proto_depIdxs = []int32{
	3, // 0: tracker.v1beta1.GetMetricsResponse.BPFPerfEventSubmitAttempts:type_name -> tracker.v1beta1.EventCount
	3, // 1: tracker.v1beta1.GetMetricsResponse.BPFPerfEventSubmitFailures:type_name -> tracker.v1beta1.EventCount
	8, // 2: tracker.v1beta1.EventCount.id:type_name -> tracker.v1beta1.EventId
	0, // 3: tracker.v1beta1.ChangeLogLevelRequest.level:type_name -> tracker.v1beta1.LogLevel
	1, // 4: tracker.v1beta1.DiagnosticService.GetMetrics:input_type -> tracker.v1beta1.GetMetricsRequest
	4, // 5: tracker.v1beta1.DiagnosticService.ChangeLogLevel:input_type -> tracker.v1beta1.ChangeLogLevelRequest
	6, // 6: tracker.v1beta1.DiagnosticService.GetStacktrace:input_type -> tracker.v1beta1.GetStacktraceRequest
	2, // 7: tracker.v1beta1.DiagnosticService.GetMetrics:output_type -> tracker.v1beta1.GetMetricsResponse
	5, // 8: tracker.v1beta1.DiagnosticService.ChangeLogLevel:output_type -> tracker.v1beta1.ChangeLogLevelResponse
	7, // 9: tracker.v1beta1.DiagnosticService.GetStacktrace:output_type -> tracker.v1beta1.GetStacktraceResponse
