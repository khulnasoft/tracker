...
var file_api_v1beta1_event_data_proto_goTypes = []any{
	...
	(*StringArray)(nil),            // 4: tracker.v1beta1.StringArray
	(*Int32Array)(nil),             // 5: tracker.v1beta1.Int32Array
	(*UInt64Array)(nil),            // 6: tracker.v1beta1.UInt64Array
	(*Credentials)(nil),            // 7: tracker.v1beta1.Credentials
	(*Timespec)(nil),               // 8: tracker.v1beta1.Timespec
	(*SockAddr)(nil),               // 9: tracker.v1beta1.SockAddr
	(*HookedSyscalls)(nil),         // 10: tracker.v1beta1.HookedSyscalls
	(*HookedSymbolData)(nil),       // 11: tracker.v1beta1.HookedSymbolData
	(*HookedSeqOps)(nil),           // 12: tracker.v1beta1.HookedSeqOps
	(*IPv4)(nil),                   // 13: tracker.v1beta1.IPv4
	(*IPv6)(nil),                   // 14: tracker.v1beta1.IPv6
	(*TCP)(nil),                    // 15: tracker.v1beta1.TCP
	(*UDP)(nil),                    // 16: tracker.v1beta1.UDP
	(*ICMP)(nil),                   // 17: tracker.v1beta1.ICMP
	(*ICMPv6)(nil),                 // 18: tracker.v1beta1.ICMPv6
	(*DnsQuestions)(nil),           // 19: tracker.v1beta1.DnsQuestions
	(*DnsResponses)(nil),           // 20: tracker.v1beta1.DnsResponses
	(*DNS)(nil),                    // 21: tracker.v1beta1.DNS
	(*DNSQuestion)(nil),            // 22: tracker.v1beta1.DNSQuestion
	(*DNSResourceRecord)(nil),      // 23: tracker.v1beta1.DNSResourceRecord
	(*DNSSOA)(nil),                 // 24: tracker.v1beta1.DNSSOA
	(*DNSSRV)(nil),                 // 25: tracker.v1beta1.DNSSRV
	(*DNSMX)(nil),                  // 26: tracker.v1beta1.DNSMX
	(*DNSURI)(nil),                 // 27: tracker.v1beta1.DNSURI
	(*DNSOPT)(nil),                 // 28: tracker.v1beta1.DNSOPT
	(*HTTP)(nil),                   // 29: tracker.v1beta1.HTTP
	(*HTTPRequest)(nil),            // 30: tracker.v1beta1.HTTPRequest
	(*HTTPResponse)(nil),           // 31: tracker.v1beta1.HTTPResponse
	(*HttpHeader)(nil),             // 32: tracker.v1beta1.HttpHeader
	(*PacketMetadata)(nil),         // 33: tracker.v1beta1.PacketMetadata
	(*DnsQueryData)(nil),           // 34: tracker.v1beta1.DnsQueryData
	(*DnsAnswer)(nil),              // 35: tracker.v1beta1.DnsAnswer
	(*DnsResponseData)(nil),        // 36: tracker.v1beta1.DnsResponseData
	nil,                            // 37: tracker.v1beta1.HookedSeqOps.ValueEntry
	nil,                            // 38: tracker.v1beta1.HTTP.HeadersEntry
	nil,                            // 39: tracker.v1beta1.HTTPRequest.HeadersEntry
	nil,                            // 40: tracker.v1beta1.HTTPResponse.HeadersEntry
...
var file_api_v1beta1_event_data_proto_depIdxs = []int32{
	4,  // 0: tracker.v1beta1.EventValue.str_array:type_name -> tracker.v1beta1.StringArray
	5,  // 1: tracker.v1beta1.EventValue.int32_array:type_name -> tracker.v1beta1.Int32Array
	6,  // 2: tracker.v1beta1.EventValue.u_int64_array:type_name -> tracker.v1beta1.UInt64Array
	9,  // 3: tracker.v1beta1.EventValue.sockaddr:type_name -> tracker.v1beta1.SockAddr
	7,  // 4: tracker.v1beta1.EventValue.credentials:type_name -> tracker.v1beta1.Credentials
	8,  // 5: tracker.v1beta1.EventValue.timespec:type_name -> tracker.v1beta1.Timespec
	10, // 6: tracker.v1beta1.EventValue.hooked_syscalls:type_name -> tracker.v1beta1.HookedSyscalls
	12, // 7: tracker.v1beta1.EventValue.hooked_seq_ops:type_name -> tracker.v1beta1.HookedSeqOps
	13, // 8: tracker.v1beta1.EventValue.ipv4:type_name -> tracker.v1beta1.IPv4
	14, // 9: tracker.v1beta1.EventValue.ipv6:type_name -> tracker.v1beta1.IPv6
	15, // 10: tracker.v1beta1.EventValue.tcp:type_name -> tracker.v1beta1.TCP
	16, // 11: tracker.v1beta1.EventValue.udp:type_name -> tracker.v1beta1.UDP
	17, // 12: tracker.v1beta1.EventValue.icmp:type_name -> tracker.v1beta1.ICMP
	18, // 13: tracker.v1beta1.EventValue.icmpv6:type_name -> tracker.v1beta1.ICMPv6
	21, // 14: tracker.v1beta1.EventValue.dns:type_name -> tracker.v1beta1.DNS
	19, // 15: tracker.v1beta1.EventValue.dns_questions:type_name -> tracker.v1beta1.DnsQuestions
	20, // 16: tracker.v1beta1.EventValue.dns_responses:type_name -> tracker.v1beta1.DnsResponses
	33, // 17: tracker.v1beta1.EventValue.packet_metadata:type_name -> tracker.v1beta1.PacketMetadata
	29, // 18: tracker.v1beta1.EventValue.http:type_name -> tracker.v1beta1.HTTP
	30, // 19: tracker.v1beta1.EventValue.http_request:type_name -> tracker.v1beta1.HTTPRequest
	31, // 20: tracker.v1beta1.EventValue.http_response:type_name -> tracker.v1beta1.HTTPResponse
	41, // 21: tracker.v1beta1.EventValue.struct:type_name -> google.protobuf.Struct
	42, // 22: tracker.v1beta1.Credentials.uid:type_name -> google.protobuf.UInt32Value
	42, // 23: tracker.v1beta1.Credentials.gid:type_name -> google.protobuf.UInt32Value
	42, // 24: tracker.v1beta1.Credentials.suid:type_name -> google.protobuf.UInt32Value
	42, // 25: tracker.v1beta1.Credentials.sgid:type_name -> google.protobuf.UInt32Value
	42, // 26: tracker.v1beta1.Credentials.euid:type_name -> google.protobuf.UInt32Value
	42, // 27: tracker.v1beta1.Credentials.egid:type_name -> google.protobuf.UInt32Value
	42, // 28: tracker.v1beta1.Credentials.fsuid:type_name -> google.protobuf.UInt32Value
	42, // 29: tracker.v1beta1.Credentials.fsgid:type_name -> google.protobuf.UInt32Value
	42, // 30: tracker.v1beta1.Credentials.user_namespace:type_name -> google.protobuf.UInt32Value
	42, // 31: tracker.v1beta1.Credentials.secure_bits:type_name -> google.protobuf.UInt32Value
	1,  // 32: tracker.v1beta1.Credentials.cap_inheritable:type_name -> tracker.v1beta1.Capability
	1,  // 33: tracker.v1beta1.Credentials.cap_permitted:type_name -> tracker.v1beta1.Capability
	1,  // 34: tracker.v1beta1.Credentials.cap_effective:type_name -> tracker.v1beta1.Capability
	1,  // 35: tracker.v1beta1.Credentials.cap_bounding:type_name -> tracker.v1beta1.Capability
	1,  // 36: tracker.v1beta1.Credentials.cap_ambient:type_name -> tracker.v1beta1.Capability
	43, // 37: tracker.v1beta1.Timespec.value:type_name -> google.protobuf.DoubleValue
	0,  // 38: tracker.v1beta1.SockAddr.sa_family:type_name -> tracker.v1beta1.sa_family_t
	11, // 39: tracker.v1beta1.HookedSyscalls.value:type_name -> tracker.v1beta1.HookedSymbolData
	37, // 40: tracker.v1beta1.HookedSeqOps.value:type_name -> tracker.v1beta1.HookedSeqOps.ValueEntry
	34, // 41: tracker.v1beta1.DnsQuestions.questions:type_name -> tracker.v1beta1.DnsQueryData
	36, // 42: tracker.v1beta1.DnsResponses.responses:type_name -> tracker.v1beta1.DnsResponseData
	22, // 43: tracker.v1beta1.DNS.questions:type_name -> tracker.v1beta1.DNSQuestion
	23, // 44: tracker.v1beta1.DNS.answers:type_name -> tracker.v1beta1.DNSResourceRecord
	23, // 45: tracker.v1beta1.DNS.authorities:type_name -> tracker.v1beta1.DNSResourceRecord
	23, // 46: tracker.v1beta1.DNS.additionals:type_name -> tracker.v1beta1.DNSResourceRecord
	24, // 47: tracker.v1beta1.DNSResourceRecord.soa:type_name -> tracker.v1beta1.DNSSOA
	25, // 48: tracker.v1beta1.DNSResourceRecord.srv:type_name -> tracker.v1beta1.DNSSRV
	26, // 49: tracker.v1beta1.DNSResourceRecord.mx:type_name -> tracker.v1beta1.DNSMX
	28, // 50: tracker.v1beta1.DNSResourceRecord.opt:type_name -> tracker.v1beta1.DNSOPT
	27, // 51: tracker.v1beta1.DNSResourceRecord.uri:type_name -> tracker.v1beta1.DNSURI
	38, // 52: tracker.v1beta1.HTTP.headers:type_name -> tracker.v1beta1.HTTP.HeadersEntry
	39, // 53: tracker.v1beta1.HTTPRequest.headers:type_name -> tracker.v1beta1.HTTPRequest.HeadersEntry
	40, // 54: tracker.v1beta1.HTTPResponse.headers:type_name -> tracker.v1beta1.HTTPResponse.HeadersEntry
	2,  // 55: tracker.v1beta1.PacketMetadata.direction:type_name -> tracker.v1beta1.PacketDirection
	34, // 56: tracker.v1beta1.DnsResponseData.dns_query_data:type_name -> tracker.v1beta1.DnsQueryData
	35, // 57: tracker.v1beta1.DnsResponseData.dns_answer:type_name -> tracker.v1beta1.DnsAnswer
	11, // 58: tracker.v1beta1.HookedSeqOps.ValueEntry.value:type_name -> tracker.v1beta1.HookedSymbolData
	32, // 59: tracker.v1beta1.HTTP.HeadersEntry.value:type_name -> tracker.v1beta1.HttpHeader
	32, // 60: tracker.v1beta1.HTTPRequest.HeadersEntry.value:type_name -> tracker.v1beta1.HttpHeader
	32, // 61: tracker.v1beta1.HTTPResponse.HeadersEntry.value:type_name -> tracker.v1beta1.HttpHeader
