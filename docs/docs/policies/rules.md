...
Rules are part of the Tracker Policy, `rules` let you define which events to trace.

`rules` have 2 sections: 
- events: let you define which events you want to trace.
- filters: enable you to refine the policy's scope.

Tracker support many kind of events to tracker you can find which events you can trace in [Events section](/docs/docs/events/index.md).
...
The [events](../events/index.md) section provides further information on the type of events that Tracker can trace.
