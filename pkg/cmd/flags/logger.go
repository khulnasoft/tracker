...
func invalidLogOption(err error, opt string, newBinary bool) error {
	...
	if newBinary {
		// TODO: build man page
		// return errfmt.Errorf("invalid log option: %s, %s, see 'tracker-log' man page for more info", opt, err)
...
func invalidLogOptionValue(err error, opt string, newBinary bool) error {
	...
	if newBinary {
		// TODO: build man page
		// return errfmt.Errorf("invalid log option value: %s, %s, see 'tracker-log' man page for more info", opt, err)
