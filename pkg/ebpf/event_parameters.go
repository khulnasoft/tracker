...
type eventParameterHandler func(t *Tracker, eventParams []map[string]filters.Filter[*filters.StringFilter]) error
...
func (t *Tracker) handleEventParameters() error {
...
func attachSuspiciousSyscallSourceProbes(t *Tracker, eventParams []map[string]filters.Filter[*filters.StringFilter]) error {
